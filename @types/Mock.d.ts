...
export interface MockContract extends Truffle.Contract<MockInstance> {
	'new'(name: string, symbol: string, meta?: Truffle.TransactionDetails): Promise<MockInstance>
}
...
export interface MockInstance extends Truffle.ContractInstance {
	/**
