...
export interface Mock2Contract extends Truffle.Contract<Mock2Instance> {
	'new'(name: string, symbol: string, meta?: Truffle.TransactionDetails): Promise<Mock2Instance>
}
...
export interface Mock2Instance extends Truffle.ContractInstance {
	/**
	...
	mint: {
		(account: string | BigNumber, amount: number | BigNumber | string, txDetails?: Truffle.TransactionDetails): Promise<
			Truffle.TransactionResponse<AllEvents>
		>
		call(account: string | BigNumber, amount: number | BigNumber | string, txDetails?: Truffle.TransactionDetails): Promise<void>
		sendTransaction(account: string | BigNumber, amount: number | BigNumber | string, txDetails?: Truffle.TransactionDetails): Promise<string>
	...
	approveInternal: {
		(owner: string | BigNumber, spender: string | BigNumber, value: number | BigNumber | string, txDetails?: Truffle.TransactionDetails): Promise<
			Truffle.TransactionResponse<AllEvents>
		>
		call(
